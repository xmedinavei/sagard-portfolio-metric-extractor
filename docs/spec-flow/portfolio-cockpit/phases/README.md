...
| `web/src/lib/trend.ts` | pure trend logic (`MIN_TREND_POINTS`, `TrendPoint`, `buildSeries`, `distinctCompanies`, `metricsForCompany`, `hasSufficientHistory`) — Phase-2-private, unit-tested | 2 |
